        ...
        <div className="min-h-screen w-full flex items-center justify-center font-sans p-4">
            ...
            <div className="w-full max-w-[440px]">
                ...
                <div className="bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 shadow-2xl shadow-black/50 rounded-2xl p-12 w-full relative z-10">
                    ...
                    {/* Header */}
                    <div className="mb-6">
                        <h1 className="text-3xl font-bold text-white mb-6 tracking-tight">Create Account</h1>
                    ...
                    <form onSubmit={handleSignUp} className="space-y-6">
                        <div className="space-y-5">
                            ...
                            {/* Password Input */}
                            <div className="space-y-2">
                                <label htmlFor="password" className="block text-sm font-medium text-slate-300 pl-1">Password</label>
                                <div className="relative group">
                                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-400 transition-colors pointer-events-none">
                                        <Lock size={18} />
                                    </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-[50px] bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg shadow-lg shadow-blue-600/20 transition-all transform active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6 text-base"
                        >
...
const RequirementBadge = ({ met, label }) => (
    ...
    `}>
        {met && <CheckCircle2 size={12} className="shrink-0" />}
        <span>{label}</span>
    </div>
);
